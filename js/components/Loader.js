...
export const LoaderNime = () => {
  ...
  //
  const loaderCounter = document.querySelector(
    '.preloader__container--counter'
  );
  const loaderCounterP = document.querySelector(
    '.preloader__container--counter p'
  );
  //
  const loaderCaption = document.querySelector(
    '.preloader__container--caption'
  );
